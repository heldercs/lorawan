...
InterferenceTest::DoRun()
{
    ...
    event = interferenceHelper.Add(Seconds(2), 14, 7, 0, 0, nullptr, frequency);
    event1 = interferenceHelper.Add(Seconds(1), 14, 12, 0, 0, nullptr, frequency);
    ...
    event = interferenceHelper.Add(Seconds(2), 14, 7, 0, 0, nullptr, frequency);
    event1 = interferenceHelper.Add(Seconds(1.5), 14, 12, 0 , 0, nullptr, frequency);
    NS_TEST_EXPECT_MSG_EQ(interferenceHelper.GetOverlapTime(event, event1),
                          Seconds(1.5),
                          "Overlap computation didn't give the expected result");
    interferenceHelper.ClearAllEvents();
    ...
    event = interferenceHelper.Add(Seconds(2), 14, 7, 0, 0, nullptr, frequency);
    event1 = interferenceHelper.Add(Seconds(3), 14, 12, 0, 0, nullptr, frequency);
    NS_TEST_EXPECT_MSG_EQ(interferenceHelper.GetOverlapTime(event, event1),
                          Seconds(2),
                          "Overlap computation didn't give the expected result");
    interferenceHelper.ClearAllEvents();
    ...
    event = interferenceHelper.Add(Seconds(2), 14, 7, 0, 0, nullptr, frequency);
    event1 = interferenceHelper.Add(Seconds(2), 14, 12, 0, 0, nullptr, frequency);
    ...
    event = interferenceHelper.Add(Seconds(2), 14, 7, 0, 0, nullptr, frequency);
    interferenceHelper.Add(Seconds(2), 14, 12, 0, 0, nullptr, frequency);
    ...
    // Perfect overlap, packet survives
    event = interferenceHelper.Add(Seconds(2), 14, 7, 0, 0, nullptr, frequency);
    interferenceHelper.Add(Seconds(2), 14 - 7, 7, 0, 0, nullptr, frequency);
    NS_TEST_EXPECT_MSG_EQ(interferenceHelper.IsDestroyedByInterference(event),
                          0,
                          "Packet did not survive interference as expected");
    interferenceHelper.ClearAllEvents();
    ...
    event = interferenceHelper.Add(Seconds(2), 14, 7, 0, 0, nullptr, frequency);
    interferenceHelper.Add(Seconds(2), 14 - 6, 7, 0, 0, nullptr, frequency);
    NS_TEST_EXPECT_MSG_EQ(interferenceHelper.IsDestroyedByInterference(event),
                          7,
    ...
    event = interferenceHelper.Add(Seconds(2), 14, 7, 0, 0, nullptr, frequency);
    interferenceHelper.Add(Seconds(1), 14 - 6, 7, 0, 0, nullptr, frequency);
    NS_TEST_EXPECT_MSG_EQ(interferenceHelper.IsDestroyedByInterference(event),
                          0,
                          "Packet did not survive interference as expected");
    interferenceHelper.ClearAllEvents();
    ...
    event = interferenceHelper.Add(Seconds(2), 14, 7, 0, 0, nullptr, frequency);
    interferenceHelper.Add(Seconds(2), 14, 7, 0, 0, nullptr, differentFrequency);
    NS_TEST_EXPECT_MSG_EQ(interferenceHelper.IsDestroyedByInterference(event),
                          0,
                          "Packet did not survive interference as expected");
    interferenceHelper.ClearAllEvents();
    ...
    // semi-orthogonality
    event = interferenceHelper.Add(Seconds(2), 14, 7, 0, 0, nullptr, frequency);
    interferenceHelper.Add(Seconds(2), 14 + 16, 8, 0, 0, nullptr, frequency);
    NS_TEST_EXPECT_MSG_EQ(interferenceHelper.IsDestroyedByInterference(event),
                          0,
                          "Packet did not survive interference as expected");
    interferenceHelper.ClearAllEvents();
    ...
    event = interferenceHelper.Add(Seconds(2), 14, 7, 0, 0, nullptr, frequency);
    interferenceHelper.Add(Seconds(2), 14 + 17, 8, 0, 0, nullptr, frequency);
    NS_TEST_EXPECT_MSG_EQ(interferenceHelper.IsDestroyedByInterference(event),
                          8,
                          "Packet was not destroyed by interference as expected");
    interferenceHelper.ClearAllEvents();
    ...
    event = interferenceHelper.Add(Seconds(2), 14, 7, 0, 0, nullptr, frequency);
    interferenceHelper.Add(Seconds(2), 14 + 17, 10, 0, 0, nullptr, frequency);
    NS_TEST_EXPECT_MSG_EQ(interferenceHelper.IsDestroyedByInterference(event),
                          0,
    ...
    event = interferenceHelper.Add(Seconds(2), 14, 7, 0, 0, nullptr, frequency);
    interferenceHelper.Add(Seconds(2), 14 + 16, 8, 0, 0, nullptr, frequency);
    interferenceHelper.Add(Seconds(2), 14 + 16, 9, 0, 0, nullptr, frequency);
    interferenceHelper.Add(Seconds(2), 14 + 16, 10, 0, 0,nullptr, frequency);
    NS_TEST_EXPECT_MSG_EQ(interferenceHelper.IsDestroyedByInterference(event),
                          0,
                          "Packet did not survive interference as expected");
    interferenceHelper.ClearAllEvents();
